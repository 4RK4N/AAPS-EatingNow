...
//    );
    ...
    if (TIR_sens_limited > 1 && !ENWindowOK && profile.EN_BGPlus_maxBolus != 0 && insulinReq_bg >= -1.5 * bg && insulinReq_bg <= threshold && delta > -4 && delta <= 6 && glucose_status.long_avgdelta > delta) {
